...
## new project and blue app from master
    ...
    oc new-app https://github.com/marieve-lapierre/blue-green.git#master --name=blue --strategy=source
...
## green app deploy
    ...
    oc new-app https://github.com/marieve-lapierre/blue-green.git#green --name=green
